...
const Resume = '/assets/files/francis-kodama-resume-2026.pdf';

const Footer = () => {
  return (
    <section
      className='section flex justify-center items-center flex-row bg-[#282828] border-t border-white/20 pb-4'
      id='footer'
    >
