      ...
      <div className='container relative flex flex-col items-center w-full min-h-[70em] mt-32 mb-20 md-custom:min-h-[110em] mx-auto'>
        ...
        <Parallax opacity={[0, 2]}>
          <ul
            ...
            style={{ display: showBackground ? 'none' : 'block' }}
          >
            <li className='[transform:skew(0deg,-30deg)_scaleY(1.33333)] text-third text-[3.75rem] leading-14md-custom:text-[7.5rem] md-custom:leading-[7rem]'>
              DRY
            </li>
            ...
            <li className='[transform:skew(0deg,-30deg)_scaleY(1.33333)] text-third text-[2.25rem] leading-[2.62rem] text-left pl-20 md-custom:text-[4.5rem] md-custom:leading-[5.25rem] md-custom:pl-32'>
              easy to read
            </li>
            <li className='[transform:skew(0deg,-30deg)_scaleY(1.33333)] text-third text-[1.875rem] leading-[2.1rem] text-left pl-[6.1em] md-custom:text-[3.75rem] md-custom:leading-[4rem] md-custom:pl-[2.4em]'>
              easy to change
            </li>
            <li className='[transform:skew(60deg,-30deg)_scaleY(0.66667)] text-bright text-[1.5rem] leading-[1.8rem] text-left pl-[8.3em] md-custom:text-[3rem] md-custom:leading-[3.75rem] md-custom:pl-[3.5em]'>
              naming
            </li>
            <li className='[transform:skew(60deg,-30deg)_scaleY(0.66667)] text-bright text-[0.82rem] leading-[1.3rem] text-left pl-[16.5em] md-custom:text-[1.65rem] md-custom:leading-[2.25rem] md-custom:pl-[7.9em]'>
              conventions
            </li>
            <li className='[transform:skew(0deg,-30deg)_scaleY(1.33333)] text-third text-[1.5em] leading-[1.87rem] text-left pl-[9.3em] md-custom:text-[3rem] md-custom:leading-[3.75rem] md-custom:pl-[4.6em]'>
              don't repeat
            </li>
            ...
            <li className='[transform:skew(60deg,-30deg)_scaleY(0.66667)] text-bright text-[2.1rem] leading-[2.62rem] pl-[0.7em] md-custom:text-[4.2rem] md-custom:leading-[5rem] md-custom:pr-[1.1em]'>
              keep it
            </li>
            <li className='[transform:skew(60deg,-30deg)_scaleY(0.66667)] text-bright text-[2.1rem] leading-[2.62rem] pl-[2.6em] md-custom:text-[4.2rem] md-custom:leading-[5rem] md-custom:pl-[0.7em]'>
              simple
            </li>
            ...
            <li className='[transform:skew(60deg,-30deg)_scaleY(0.66667)] text-bright text-[2.25rem] leading-[2.85rem] text-left pl-24 md-custom:text-[3.5rem] md-custom:leading-[4.5rem] md-custom:pl-[4.2em]'>
              consistency
            </li>
