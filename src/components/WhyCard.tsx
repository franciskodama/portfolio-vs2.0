...
const WhyCard = ({
  ...
  return (
    <div
      className='absolute flex w-max items-end -translate-x-1/2 text-bright z-10'
    ...
    >
      ...
      >
        ...
        >
          <h2
            className="font-main-semibold text-[1.1rem] bg-[0_0] bg-no-repeat bg-size-[1.5em_1.5em] pl-10 pb-2 bg-[url('../assets/images/why-icon-flag.svg')]"
        ...
        >
          <h2
            className="font-main-semibold text-[1.1rem] bg-[0_0] bg-no-repeat bg-size-[1.5em_1.5em] pl-10 pb-2 bg-[url('../assets/images/why-icon-bolt.svg')]"
        ...
        >
          <h2
            className="font-main-semibold text-[1.1rem] bg-[0_0] bg-no-repeat bg-size-[1.5em_1.5em] pl-10 pb-2 bg-[url('../assets/images/why-icon-robot.svg')]"
        ...
        >
          <h2
            className="font-main-semibold text-[1.1rem] bg-[0_0] bg-no-repeat bg-size-[1.5em_1.5em] pl-10 pb-2 bg-[url('../assets/images/why-icon-brush.svg')]"
