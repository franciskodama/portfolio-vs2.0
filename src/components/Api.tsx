...
const Api = () => {
  ...
  return (
    <div className='api-external relative'>
      ...
      <section
        className='section bg-bright text-dark py-32 pb-40 w-full [clip-path:polygon(0_0,100%_0,100%_calc(100%-10vw),0_100%)] md-custom:py-48 md-custom:pb-56 lg-custom:py-56 lg-custom:pb-44'
        id='api'
      >
        <div className='container mx-auto'>
          <div className='grid grid-cols-4 grid-rows-[repeat(12,auto)] w-[90%] mx-auto mb-12 md-custom:w-[60%] lg-custom:grid-cols-8 lg-custom:grid-rows-[auto_auto_4em_repeat(6,auto)] lg-custom:w-[65%]'>
            <div className='col-span-4 row-span-1 row-start-2 flex flex-col leading-12 font-main-semibold text-[2.8rem] lg-custom:w-[18em]'>
              <h2>What city</h2>
              <h2>are you in?</h2>
              <input
            ...
            <p
              className={`col-span-4 row-start-3 mb-[4.8em] font-main-regular text-[0.9rem] w-[20em] text-bright bg-third p-2 text-center animate-appear -z-10 lg-custom:col-span-3 lg-custom:mb-8 ${
                error ? 'block' : 'hidden'
              }`}
            >
            ...
            <h4 className='col-span-4 row-start-3 mt-20 font-main-regular lg-custom:col-span-1 lg-custom:row-start-5 lg-custom:mt-0'>
              Weather in
            </h4>
            <h3 className='col-span-4 row-start-4 text-[3rem] font-main-semibold uppercase leading-14 lg-custom:row-start-6 lg-custom:text-[4rem] lg-custom:leading-18'>
              {data.name}
            </h3>
            {data.sys ? (
              <h3 className='col-span-3 row-start-5 text-[2rem] font-main-semibold uppercase leading-14 lg-custom:row-start-7 lg-custom:text-[3rem] lg-custom:leading-18'>
                {data.sys.country}
              </h3>
            ) : null}
            ...
            <h4 className='col-span-1 row-start-6 mt-20 font-main-regular text-[0.8rem] inline-block lg-custom:row-start-8 lg-custom:mt-8'>
              Longitude{' '}
              {data.coord ? (
                <span className='font-main-semibold text-[1.5rem] inline'>
                  {data.coord.lon}
                </span>
              ) : null}
            </h4>
            ...
            <h5 className='hidden lg-custom:block lg-custom:col-start-7 lg-custom:row-start-2 font-main-semibold text-[0.8rem] mt-12'>
              °C
            </h5>
            ...
            <div className='col-span-4 row-start-8 flex flex-col text-right p-2 ml-4 lg-custom:col-span-2 lg-custom:col-start-7 lg-custom:row-start-2'>
              ...
              <h3>
                {data.main ? (
                  <span className='font-main-semibold text-5xl -mb-2 md-custom:text-[5rem] block'>
            ...
            <div className='col-span-1 col-start-2 row-start-9 mt-12 flex flex-col text-right p-2 ml-4 lg-custom:col-start-7 lg-custom:row-start-4 lg-custom:mt-0'>
              ...
              <h3>
                {data.wind ? (
                  <span className='font-main-semibold text-[1.5rem] block'>
                    {data.wind.speed}
                  </span>
                ) : null}
              </h3>
